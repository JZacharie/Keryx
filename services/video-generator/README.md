# 🎥 Keryx - Video Generator Animation Microservice

The **Video Generator** microservice is responsible for generating high-quality looped animations from static frames extracted during the **Keryx** pipeline.
